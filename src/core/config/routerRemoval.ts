...
const ROUTER_REMOVAL_DEFAULT_MESSAGE =
	"Vertex Code Router has been removed. Please select and configure a different provider."
...
const ROUTER_SIGN_IN_UNAVAILABLE_DEFAULT_MESSAGE =
	"Vertex Code Cloud sign-in is currently unavailable. Configure another provider to continue."
...
export const ROUTER_REMOVAL_IMPORT_WARNING =
	"Vertex Code Router was removed. The imported profile was downgraded and needs to be reconfigured."
