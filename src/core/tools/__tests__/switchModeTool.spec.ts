...
describe("SwitchModeTool", () => {
	...
	it("should successfully switch mode with reason", async () => {
		...
		expect(mockHandleModeSwitch).toHaveBeenCalledWith("architect", { handoffTrigger: "tool_switch_mode" })
	...
	it("should successfully switch mode without reason", async () => {
		...
		expect(mockHandleModeSwitch).toHaveBeenCalledWith("ask", { handoffTrigger: "tool_switch_mode" })
	...
	it("should switch to a custom mode", async () => {
		...
		expect(mockCallbacks.askApproval).toHaveBeenCalled()
		expect(mockHandleModeSwitch).toHaveBeenCalledWith("custom-mode", { handoffTrigger: "tool_switch_mode" })
		expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(
	...
	it("should read current mode from providerRef state", async () => {
		...
		expect(mockHandleModeSwitch).toHaveBeenCalledWith("code", { handoffTrigger: "tool_switch_mode" })
		expect(mockCallbacks.pushToolResult).toHaveBeenCalledWith(
