...
import type { ModeConfig } from "@vertex-code/types"

import type { Mode } from "@vertex/modes"
...
vi.mock("@/components/ui/hooks/useVertexPortal", () => ({
	useVertexPortal: () => document.body,
}))
...
vi.mock("@vertex/modes", async () => {
	const actual = await vi.importActual<typeof import("@vertex/modes")>("@vertex/modes")
	return {
		...actual,
