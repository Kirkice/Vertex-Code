			...
			<DialogContent>
				...
				<div>
					...
					<div className="mb-4 p-3 rounded border border-vscode-textLink-foreground/40 bg-vscode-textLink-foreground/5">
						...
						<VSCodeLink
							href="https://www.vertex.dev?utm_source=vertex&utm_medium=announcement&utm_campaign=community_handoff"
							onClick={(e) => {
								e.preventDefault()
								vscode.postMessage({
									type: "openExternal",
									url: "https://www.vertex.dev?utm_source=vertex&utm_medium=announcement&utm_campaign=community_handoff",
								})
							}}>
					...
					<div className="mt-4 text-sm text-center text-vscode-descriptionForeground">
						<div className="flex items-center justify-center gap-4">
							...
							<SocialLink
								...
								label="Reddit"
								href="https://www.reddit.com/r/Vertex/"
							/>
						</div>
					</div>
