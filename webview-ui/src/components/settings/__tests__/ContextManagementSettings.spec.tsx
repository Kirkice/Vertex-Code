...
describe("ContextManagementSettings", () => {
	...
	it("renders other context management settings", () => {
		...
		expect(screen.getByTestId("show-vertexignored-files-checkbox")).toBeInTheDocument()
	...
	it("handles undefined optional props gracefully", () => {
		const propsWithUndefined = {
			...defaultProps,
			showVertexIgnoredFiles: undefined,
		}
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.vertexignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.vertexignore.description")).toBeInTheDocument()
		})
