...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@vertex-code/types"
...
/**
 * Validate skill name using shared validation from @vertex-code/types.
