 ...
 *
 * This class manages the state for the marketplace view in the Vertex extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Vertex extensions interface
