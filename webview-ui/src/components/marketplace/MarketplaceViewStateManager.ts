 ...
 *
 * This class manages the state for the marketplace view in the Vertex Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Vertex Code extensions interface
