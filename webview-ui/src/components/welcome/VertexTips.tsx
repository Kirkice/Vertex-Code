...
const tips = [
	{
		...
		titleKey: "vertexTips.customizableModes.title",
		descriptionKey: "vertexTips.customizableModes.description",
	},
	{
		icon: <ReplaceAll className="size-4 shrink-0 mt-0.5" />,
		href: buildDocLink("getting-started/connecting-api-provider", "tips"),
		titleKey: "vertexTips.modelAgnostic.title",
		descriptionKey: "vertexTips.modelAgnostic.description",
	},
]
