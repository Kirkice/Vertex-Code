/**
 * Validates the generated schemas/vertexmodes.json against sample configurations
 * using AJV. The schema itself is dynamically generated from the Zod types in
 * packages/types/src/mode.ts -- see packages/types/scripts/generate-vertexmodes-schema.ts.
 *
 * A separate drift-detection test (vertexmodes-schema-sync.spec.ts) ensures the
...
describe("vertexmodes JSON schema", () => {
	...
	it("should accept a minimal valid .vertexmodes config", () => {
		const config = {
			customModes: [
				{
					slug: "my-mode",
