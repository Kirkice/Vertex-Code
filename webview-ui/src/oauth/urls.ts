...
const VERTEX_DEFAULT_BASE_URL = "https://www.vertex.dev"

export function getVertexAuthUrl(uriScheme?: string, baseUrl?: string, deviceName?: string) {
	const resolvedBaseUrl = baseUrl || VERTEX_DEFAULT_BASE_URL
