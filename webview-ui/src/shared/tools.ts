...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@vertex-code/types"
...
export type NativeToolArgs = {
	...
	read_file: import("@vertex-code/types").ReadFileToolParams
