<p align="center">
        ...
        <p align="center">
          <em>Snel hulp nodig → <a href="https://discord.gg/VxfP4Vx3gX">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/Vertex/">Word lid van r/Vertex</a></em>
        </p>
...
Vertex past zich aan jouw werkwijze aan, niet andersom:
...
Meer info: [Modi gebruiken](https://docs.vertex.dev/basic-usage/using-modes) • [Aangepaste modi](https://docs.vertex.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.vertex.dev/tutorial-videos">Meer snelle tutorial- en featurevideo's...</a>
</p>

## Hulpbronnen

- **[Documentatie](https://docs.vertex.dev):** De officiële gids voor het installeren, configureren en beheersen van Vertex.
...
- **[Reddit Community](https://www.reddit.com/r/Vertex):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/Kirkice/Vertex-Code/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/Kirkice/Vertex-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de Vertex-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de Vertex-extensie wordt uitgevoerd.
...
1.  Bouw eerst het VSIX-pakket:
    ...
    pnpm vsix
    ```
2.  Een `.vsix`-bestand wordt gegenereerd in de `bin/`-directory (bijv. `bin/vertex-<version>.vsix`).
...
**Veel plezier met Vertex!** Of je het nu kort aangelijnd houdt of autonoom laat rondzwerven, we kunnen niet wachten om te zien wat je bouwt. Als je vragen of feature-ideeën hebt, open dan een [issue](https://github.com/Kirkice/Vertex-Code/issues) of start een [discussion](https://github.com/Kirkice/Vertex-Code/discussions). Veel codeerplezier!
