...
### 3. Bergabunglah dengan Komunitas Vertex

- **Discord:** Bergabunglah dengan [Discord](https://discord.gg/VxfP4Vx3gX) kami.
- **Reddit:** Bergabunglah dengan [Reddit](https://www.reddit.com/r/Vertex/) kami.
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/Kirkice/Vertex-Code/issues).
...
- Periksa [halaman GitHub Issues](https://github.com/Kirkice/Vertex-Code/issues) untuk melihat issues.
- Untuk dokumentasi, kunjungi [Dokumentasi Vertex](https://github.com/Kirkice/Vertex-Code-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/Kirkice/Vertex-Code/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi Vertex (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/Kirkice/Vertex-Code/security/advisories/new).
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi Vertex.
