...
### 3. Tham gia cộng đồng Vertex

- **Discord:** Tham gia [Discord](https://discord.gg/VxfP4Vx3gX) của chúng tôi.
- **Reddit:** Tham gia [Reddit](https://www.reddit.com/r/Vertex/) của chúng tôi.
...
- **Kiểm tra các vấn đề hiện có**: Tìm kiếm trong [Vấn đề trên GitHub](https://github.com/Kirkice/Vertex-Code/issues).
...
- Hãy xem [trang GitHub Issues](https://github.com/Kirkice/Vertex-Code/issues) để tìm issues.
- Để biết tài liệu, hãy truy cập [Tài liệu Vertex](https://github.com/Kirkice/Vertex-Code-Docs).

### Báo cáo lỗi

- Trước tiên hãy kiểm tra các báo cáo hiện có.
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/Kirkice/Vertex-Code/issues/new/choose) với:
    - Các bước tái tạo rõ ràng, được đánh số
    - Kết quả mong đợi so với thực tế
    - Phiên bản Vertex (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
- **Vấn đề bảo mật**: Báo cáo riêng tư qua [tư vấn bảo mật](https://github.com/Kirkice/Vertex-Code/security/advisories/new).
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của Vertex.
