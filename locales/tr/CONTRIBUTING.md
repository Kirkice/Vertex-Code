...
# Vertex'a Katkıda Bulunma

Vertex topluluk tarafından yürütülen bir projedir ve her katkıyı derinden takdir ediyoruz. İşbirliğini kolaylaştırmak için [Önce Sorun Yaklaşımı](#önce-sorun-yaklaşımı) temelinde çalışıyoruz, bu da tüm [Çekme İsteklerinin (PR'ler)](#pull-request-guidelines) önce bir GitHub Sorununa bağlanması gerektiği anlamına gelir. Lütfen bu kılavuzu dikkatlice inceleyin.
...
### 3. Vertex topluluğuna katıl

- **Discord:** [Discord](https://discord.gg/VxfP4Vx3gX) sunucumuza katıl.
- **Reddit:** [Reddit](https://www.reddit.com/r/Vertex/) topluluğumuza katıl.
...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/Kirkice/Vertex-Code/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- Issue bulmak için [GitHub Issues sayfasına](https://github.com/Kirkice/Vertex-Code/issues) bak.
- Belgeler için [Vertex Belgeleri](https://github.com/Kirkice/Vertex-Code-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/Kirkice/Vertex-Code/issues/new/choose) kullanarak yeni bir hata oluşturun:
    - Açık, numaralandırılmış yeniden oluşturma adımları
    - Beklenen vs gerçek sonuç
    - Vertex sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/Kirkice/Vertex-Code/security/advisories/new) aracılığıyla özel olarak bildirin.
...
Katkıda bulunarak, katkılarınızın Vertex'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
