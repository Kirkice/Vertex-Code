...
### 3. Junte-se à comunidade do Vertex

- **Discord:** Entre no nosso [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Entre no nosso [Reddit](https://www.reddit.com/r/Vertex/).
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/Kirkice/Vertex-Code/issues).
...
- Confira a [página de GitHub Issues](https://github.com/Kirkice/Vertex-Code/issues) para ver as issues.
- Para documentação, visite [Documentação do Vertex](https://github.com/Kirkice/Vertex-Code-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/Kirkice/Vertex-Code/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do Vertex (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular por meio de [avisos de segurança](https://github.com/Kirkice/Vertex-Code/security/advisories/new).
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Vertex.
