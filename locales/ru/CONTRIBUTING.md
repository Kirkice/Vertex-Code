...
### 3. Присоединяйся к сообществу Vertex

- **Discord:** Присоединяйся к нашему [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Присоединяйся к нашему [Reddit](https://www.reddit.com/r/Vertex/).
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/Kirkice/Vertex-Code/issues).
...
- Проверь [страницу GitHub Issues](https://github.com/Kirkice/Vertex-Code/issues), чтобы найти issues.
- Для документации посетите [Документацию Vertex](https://github.com/Kirkice/Vertex-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/Kirkice/Vertex-Code/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Vertex (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/Kirkice/Vertex-Code/security/advisories/new).
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Vertex.
