...
export const openAiNativeModels = {
	...
	"gpt-5.6": {
		...
		description: "GPT-5.6: Our most capable model for professional work",
	},
	"gpt-5.6-sol": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		supportsTemperature: false,
		tiers: [
			{ name: "flex", contextWindow: 400000, inputPrice: 1.25, outputPrice: 7.5, cacheReadsPrice: 0.125 },
			{ name: "priority", contextWindow: 400000, inputPrice: 5.0, outputPrice: 30.0, cacheReadsPrice: 0.5 },
		],
		description: "GPT-5.6 Sol: Detail and polish variant of GPT-5.6",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		description: "GPT-5.6 Terra: Everyday workhorse variant of GPT-5.6",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		description: "GPT-5.6 Luna: Clear, repeatable work variant of GPT-5.6",
	},
	"gpt-5.5": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		description: "GPT-5.5: Most capable model for professional work",
	},
	"gpt-5.4": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
