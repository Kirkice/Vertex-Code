...
export const openAiCodexModels = {
	...
	"gpt-5.6": {
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6: Most capable model via ChatGPT subscription",
	},
	"gpt-5.6-sol": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Sol: Detail and polish via ChatGPT subscription",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Terra: Everyday workhorse via ChatGPT subscription",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 400000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Luna: Clear, repeatable work via ChatGPT subscription",
	},
	"gpt-5.4": {
		maxTokens: 128000,
